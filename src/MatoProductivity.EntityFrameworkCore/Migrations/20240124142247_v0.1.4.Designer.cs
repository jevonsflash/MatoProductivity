...
namespace MatoProductivity.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20240124142247_v0.1.4")]
    partial class v014
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteSegmentStore", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("NoteSegmentStore");
                });

            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteSegmentTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("NoteTemplateId")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("NoteSegmentTemplate");
                });

            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteSegmentTemplatePayload", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("NoteSegmentTemplateId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("NoteSegmentTemplateId");

                    b.ToTable("NoteSegmentTemplatePayload");
                });

            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.Setting", b =>
                {
            ...
            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteSegmentTemplate", b =>
                {
                    b.HasOne("MatoProductivity.Core.Models.Entities.NoteTemplate", "NoteTemplate")
                        .WithMany("NoteSegmentTemplates")
            ...
            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteSegmentTemplatePayload", b =>
                {
                    b.HasOne("MatoProductivity.Core.Models.Entities.NoteSegmentTemplate", "NoteSegmentTemplate")
                        .WithMany("NoteSegmentTemplatePayloads")
                        .HasForeignKey("NoteSegmentTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NoteSegmentTemplate");
                });

            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.Note", b =>
                {
                    b.Navigation("NoteSegments");
                });
            ...
            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteSegmentTemplate", b =>
                {
                    b.Navigation("NoteSegmentTemplatePayloads");
                });

            modelBuilder.Entity("MatoProductivity.Core.Models.Entities.NoteTemplate", b =>
                {
                    b.Navigation("NoteSegmentTemplates");
                });
