        ...
        public INoteSegmentService GetNoteSegmentService(NoteSegmentTemplate noteSegmentTemplate)
        {
            ...
            switch (type)
            {
                ...
                case "LocationSegment":
                    using (var objWrapper = iocResolver.ResolveAsDisposable<LocationSegmentService>(new { noteSegment = noteSegmentTemplate }))
                    {
                        newModel = objWrapper.Object;
                    }
                    break;
                ...
                case "ContactSegment":
                    using (var objWrapper = iocResolver.ResolveAsDisposable<ContactSegmentService>(new { noteSegment = noteSegmentTemplate }))
                    {
                        newModel = objWrapper.Object;
                    }
                    break;
                ...
                case "WeatherSegment":
                    using (var objWrapper = iocResolver.ResolveAsDisposable<WeatherSegmentService>(new { noteSegment = noteSegmentTemplate }))
                    {
                        newModel = objWrapper.Object;
                    }
                    break;
